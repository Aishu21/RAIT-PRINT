...
$(document).ready(function(){
    ...
    <div class="nav nav-justified row" id="myNavbar" >
		...
		<div class="col-sm-2 active"><a href="recharge.php" >Recharge</a></div>
  ...
  <br>
	...
	<div class="well">
		<h4>Recharge for 100Rs and Get 105rs/- in Your Rait-Print Wallet</h4>
		<a href="http://118.102.168.162:81/raitpay/">
		<button class="btn primary" type="button" style="background-color:#8D0B03 ;color:white;">Select</button>
		</a>
	</div>
	<div class="well">
		<h4>Recharge for 200Rs and Get 210rs/- in Your Rait-Print Wallet</h4>
		<a href="http://118.102.168.162:81/raitpay/">
		<button class="btn primary" type="button" style="background-color:#8D0B03 ;color:white;">Select</button>
		</a>
	</div>
	<div class="well">
		<h4>Recharge for 300Rs and Get 315rs/- in Your Rait-Print Wallet</h4>
		<a href="http://118.102.168.162:81/raitpay/">
		<button class="btn primary" type="button" style="background-color:#8D0B03 ;color:white;">Select</button>
		</a>
	</div>
	<div class="well">
		<h4>Recharge for 400Rs and Get 420rs/- in Your Rait-Print Wallet</h4>
		<a href="http://118.102.168.162:81/raitpay/">
		<button class="btn primary" type="button" style="background-color:#8D0B03 ;color:white;">Select</button>
		</a>
	</div>
	<div class="well">
		<h4>Recharge for 500Rs and Get 525rs/- in Your Rait-Print Wallet</h4>
		<a href="http://118.102.168.162:81/raitpay/">
		<button class="btn primary" type="button" style="background-color:#8D0B03 ;color:white;">Select</button>
		</a>
	</div>	
	<div class="well">
		<h4>Recharge for 1000Rs and Get 1050rs/- in Your Rait-Print Wallet</h4>
		<a href="http://118.102.168.162:81/raitpay/">
		<button class="btn primary" type="button" style="background-color:#8D0B03 ;color:white;">Select</button>
		</a>
	</div>

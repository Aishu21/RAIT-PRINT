...
<br>
	...
	<nav class="navbar navbar-default" >
		...
		<div class="nav nav-justified row" id="myNavbar" >
			...
			<div class="col-sm-3 active"><a href="whyrait.php" >Why RAIT PRINT?</a></div>
			<div class="col-sm-3"><a href="aboutus.php" >About Us</a></div>
		  
		</div>
	</nav><br>
	<h1 style="font-family:algerian">RAIT-PRINT</h1>
	<div class="well well-lg" style="background-color:#8D0B03;color:white;">
	
<br>
<div class="container text-justify">	
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	Students and faculties of RAIT faced problems while printing such as long queues, chaos of public,
wastage of time, etc. In short faced problem of lack of good printing facility .So our attempt is to
solve this problem by easing the printing method to an extent that people can request to print right
from the place they are sitting.
	This is an efficient web application printing system which will help users to get printouts
without wastage of time using scheduling algorithm ensuring two way authentication for
confidential document with the facility of storage of documents in private cloud and payment
through recharge wallet.
		This website can help students and faculties to get print whenever needed by just
giving print command via cell, PC`s or systems on each floor and take print. One can save various
types of documents for future use in private cloud. Even the confidentiality of document can be
maintained.
</div>
<br>
<div class="jumbotron" style="color:#8D0B03">
<h2>Features</h2>
<br>
-You can SHARE, STORE, PRINT and PAY any desired Documents.<br><br>

-Accessible from Mobile, PC & systems on every floor of RAIT.<br><br>

-Desired documents can be STORED AND ENCRYPTED.<br><br>

-Easy access to PRINTERS .<br><br>

-It will help students and faculties of RAIT to save time and money to take prints.<br><br>

-Two STEP print process :--<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	1)Giving print command to scheduler from the stored data.(Confidentiality can be maintained)<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	2)Scheduling the requests using round robin scheduling algorithm based as per availabilty. (max.10 req at a time )<br><br>

-Easy payment mode by WALLET which gets filled through RAIT PAY.<br><br>

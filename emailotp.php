...
$body = "Hi $r->name. Here is your OTP information. Your OTP is $otp . Use this OTP for recieving prints. Regards Site Admin";
...
$resu = mysqli_query($conn," UPDATE signup SET OTP = '$otp' WHERE  rollno= '$rollno' ") or die("could not update.mysqli_error()");

...
if(isset($_POST['oldpass'])){
	...
	{
if(isset($_POST['newpass']) && isset($_POST['newconpass'])){
	$newpass = $_POST['newpass'];
	$newconpass = $_POST['newconpass'];
	if($newpass!="" && $newconpass!="" )

	{if(strlen($newpass)>=6 && strlen($newconpass)>=6) {
		if($newpass == $newconpass ){
		$id1 = $_POST['id_name'];
	$sql = "UPDATE signup SET password= '$newpass', confirmpassword= '$newconpass' WHERE  rollno= '$id1' ";
...
unset($_SESSION['id']);
	header("Location:Home4.php");
		...
		echo "Password length must be greater than six";
	}
	}
}
}
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/userprofile.png" class="img-fluid " width="100" height="100" /><br><br>
			...
			<form action="changepassword.php" method="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-2">	ENTER OLD PASSWORD		<br> 		</div>
				...
				<div class="form-group row">
					<div class="col-sm-4">						<br>		</div>
					<div class="col-sm-2">	PASSWORD				<br> 		</div>
					<div class="col-sm-1">	:					<br>		</div>
					<div class="col-sm-3">
				...
				<div class="form-group row">
					<div class="col-sm-4">						<br>		</div>
					<div class="col-sm-2">	CONFIRMPASSWORD				<br> 		</div>
					<div class="col-sm-1">	:					<br>		</div>
					<div class="col-sm-3">
					<input class="form-control" type="password" name="newconpass">
					</div>
				</div>
